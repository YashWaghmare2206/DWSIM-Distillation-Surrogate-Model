...
# 500 points
#
# Each dimension is stratified into 500 intervals and one
# sample is selected from each interval.
# ------------------------------------------------------------
...
lhs_points = sampler.random(
    n=TOTAL_POINTS
)


print(
    "LHS points generated."
)

print(
    f"Using {TOTAL_POINTS} LHS points."
)
...
print()
print("=" * 75)
print("LHS + DWSIM GENERATION COMPLETE")
print("=" * 75)
